...
* Modified cmdlet `New-AzVM`
   - Added parameter `-EnableProxyAgent`
* Modified cmdlet `New-AzVmss`
   - Added parameter `-EnableProxyAgent`
* Modified cmdlet `Update-AzVmssVM`
   - Added parameter `-ProxyAgentKeyIncarnationId`
* Added cmdlet `Add-AzGalleryInVMAccessControlProfileVersionRulesIdentity`, `Add-AzGalleryInVMAccessControlProfileVersionRulesPrivilege`, `Add-AzGalleryInVMAccessControlProfileVersionRulesRole`, `Add-AzGalleryInVMAccessControlProfileVersionRulesRoleAssignment`, `Get-AzGalleryInVMAccessControlProfile`, `Get-AzGalleryInVMAccessControlProfileVersion`, `New-AzGalleryInVMAccessControlProfile`, `New-AzGalleryInVMAccessControlProfileVersion`, `New-AzGalleryInVMAccessControlProfileVersionConfig`, `Remove-AzGalleryInVMAccessControlProfile`, `Remove-AzGalleryInVMAccessControlProfileVersion`, `Remove-AzGalleryInVMAccessControlProfileVersionRulesIdentity`, `Remove-AzGalleryInVMAccessControlProfileVersionRulesPrivilege`, `Remove-AzGalleryInVMAccessControlProfileVersionRulesRole`, `Remove-AzGalleryInVMAccessControlProfileVersionRulesRoleAssignment`, `Set-AzVMProxyAgentSetting`, `Set-AzVmssProxyAgentSetting`, `Update-AzGalleryInVMAccessControlProfile`, `Update-AzGalleryInVMAccessControlProfileVersion`
#### Az.MySql 1.5.0 
