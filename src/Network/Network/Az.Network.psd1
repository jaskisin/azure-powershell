...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Updated cmdlet ''New-AzFirewallPolicyApplicationRule'' to use HTTPS as the default protocol when creating a new FQDN Tag application rule.
