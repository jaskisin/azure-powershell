...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMware.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Lock, @"AzVMwareVirtualMachineMovement_RestrictViaIdentityClusterExpanded", SupportsShouldProcess = true)]
        ...
        Microsoft.Azure.PowerShell.Cmdlets.VMware.Runtime.IContext
    {
        ...
        /// <returns>
        /// a duplicate instance of LockAzVMwareVirtualMachineMovement_RestrictViaIdentityClusterExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.VMware.Cmdlets.LockAzVMwareVirtualMachineMovement_RestrictViaIdentityClusterExpanded Clone()
        {
            var clone = new LockAzVMwareVirtualMachineMovement_RestrictViaIdentityClusterExpanded();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LockAzVMwareVirtualMachineMovement_RestrictViaIdentityClusterExpanded" />
        /// cmdlet class.
        /// </summary>
        public LockAzVMwareVirtualMachineMovement_RestrictViaIdentityClusterExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.ClusterInputObject.Id += $"/virtualMachines/{(global::System.Uri.EscapeDataString(this.VirtualMachineId.ToString()))}";
                        await this.Client.VirtualMachinesRestrictMovementViaIdentity(ClusterInputObject.Id, _restrictMovementBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VirtualMachinesRestrictMovement(ClusterInputObject.SubscriptionId ?? null, ClusterInputObject.ResourceGroupName ?? null, ClusterInputObject.PrivateCloudName ?? null, ClusterInputObject.ClusterName ?? null, VirtualMachineId, _restrictMovementBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { VirtualMachineId=VirtualMachineId})
                    {
